...
class LossCategoricalCrossEntropy(loss):
    ...
    def forward(self,y_pred,y_true): #basicamente o y_pred vai ser o resultado do ultimo layer do mlp , ou seja do softmax e o y vai ser os valores reais
        ...
        if len (y_true.shape) == 1:
            correct_confidences = y_pred_clipped[range(samples),y_true] #valores normais
        ...
        negative_log_likelihoods = -np.log(correct_confidences)  #retorna a loss, basicamente
    ...
    def backward(self,dvalues,y_true):
        ...
        self.dinputs[range(samples), y_true] -= 1   # para pegar as probabilidades e calcula as derivadas
   ...
   def treinar(self):
    ...
    for epoch in range(epochs):
        ...
        for batch in range(num_batches): # vai ver todas as batches
            ...
            layer3.backward(loss_func.dinputs)                    #basicamente faço o backporpagation
            ...
            learning_rate = 0.1
            layer1.weights -= learning_rate * layer1.dweights        #so atualizo os pesos cm os novos 
